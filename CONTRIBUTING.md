...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-docker-manager.git
cd blackroad-docker-manager

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-docker-manager.git
